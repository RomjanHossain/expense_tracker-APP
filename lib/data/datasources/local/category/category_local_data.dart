...
final categoryLocalData = <String, CategoryLocalModel>{
  'Housing': const CategoryLocalModel(
    ...
    items: [
      ...
      CategoryModel(
          id: 'householdRepairs', title: 'Household repairs', icon: '🔧'),
      ...
      CategoryModel(
          ...
          icon: '🧹'),
      CategoryModel(
          id: 'pestControl', title: 'Pest control services', icon: '🐜'),
      CategoryModel(
          id: 'landscaping',
  ...
  'Food': const CategoryLocalModel(
    ...
    items: [
      ...
      CategoryModel(
          id: 'mealDelivery', title: 'Meal delivery services', icon: '🍔'),
      CategoryModel(
          id: 'dietarySupplements', title: 'Dietary supplements', icon: '💊'),
    ],
  ),
  'Utilities': const CategoryLocalModel(
    ...
    items: [
      ...
      CategoryModel(
          id: 'renewableEnergy', title: 'Renewable energy costs', icon: '☀️'),
      CategoryModel(
          id: 'smartHomeDevices', title: 'Smart home devices', icon: '🏡💡'),
    ],
  ),
  'Clothing': const CategoryLocalModel(
    ...
    items: [
      CategoryModel(
          id: 'adultsClothing', title: 'Adults’ clothing', icon: '👚'),
      CategoryModel(id: 'adultsShoes', title: 'Adults’ shoes', icon: '👠'),
      CategoryModel(
          id: 'childrensClothing', title: 'Children’s clothing', icon: '👕'),
      CategoryModel(
          id: 'childrensShoes', title: 'Children’s shoes', icon: '👟'),
  ...
  'Medical/Healthcare': const CategoryLocalModel(
    ...
    items: [
      ...
      CategoryModel(
          ...
          icon: '💳⚕️'),
      CategoryModel(
          id: 'visionCareExpenses', title: 'Vision care expenses', icon: '👓'),
      CategoryModel(
          id: 'mentalHealthServices',
          title: 'Mental health services',
          icon: '🧠'),
      CategoryModel(
          id: 'alternativeMedicine', title: 'Alternative medicine', icon: '🍃'),
    ],
  ),
  'Insurance': const CategoryLocalModel(
    ...
    items: [
      CategoryModel(
          id: 'healthInsurance', title: 'Health insurance', icon: '🩺🔒'),
      CategoryModel(
  ...
  'Household Items/Supplies': const CategoryLocalModel(
    ...
    items: [
      ...
      CategoryModel(
          id: 'laundryDetergent', title: 'Laundry detergent', icon: '🧺'),
      CategoryModel(
          id: 'dishwasherDetergent',
          title: 'Dishwasher detergent',
          icon: '🍽️'),
      CategoryModel(
          id: 'cleaningSupplies', title: 'Cleaning supplies', icon: '🧹'),
  ...
  'Personal': const CategoryLocalModel(
    ...
    items: [
      CategoryModel(
          id: 'gymMemberships', title: 'Gym memberships', icon: '🏋️'),
      ...
      CategoryModel(
          ...
          icon: '📚'),
      CategoryModel(
          id: 'travelEssentials', title: 'Travel essentials', icon: '🌍'),
      CategoryModel(
  ...
  'Debt': const CategoryLocalModel(
    ...
    items: [
      ...
      CategoryModel(
          id: 'otherTypesOfLoans', title: 'Other types of loans', icon: '💰'),
      CategoryModel(
          id: 'debtSettlementFees', title: 'Debt settlement fees', icon: '💸'),
  ...
  'Retirement': const CategoryLocalModel(
    ...
    items: [
      CategoryModel(
          id: 'financialPlanning', title: 'Financial planning', icon: '💹'),
  ...
  'Education': const CategoryLocalModel(
    ...
    items: [
      CategoryModel(
          id: 'childrensCollege', title: 'Children’s college', icon: '👨‍🎓'),
  ...
  'Gifts/Donations': const CategoryLocalModel(
    ...
    items: [
      ...
      CategoryModel(
          id: 'specialOccasion', title: 'Special occasion', icon: '🎈'),
  ...
  'Entertainment': const CategoryLocalModel(
    ...
    items: [
      CategoryModel(
          id: 'alcoholBars', title: 'Alcohol and/or bars', icon: '🍻'),
      ...
      CategoryModel(
          ...
          icon: '📺'),
      CategoryModel(
          id: 'sportsEventsTickets', title: 'Sports events tickets', icon: '⚽'),
    ],
  ),
};
