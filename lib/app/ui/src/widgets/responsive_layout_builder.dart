  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= ExpenseTrackerBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= ExpenseTrackerBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= ExpenseTrackerBreakpoints.large) {
